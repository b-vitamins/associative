#!/usr/bin/env python3
"""Inference script for Image Reconstruction on CIFAR-100 - reconstruct individual images."""
...
def load_and_preprocess_image(image_path: str, mean: tuple, std: tuple) -> torch.Tensor:
    ...
    if image_path == "random":
        # Generate random CIFAR-100 like image
...
def main(cfg: DictConfig) -> None:
    ...
    mean = (0.5071, 0.4866, 0.4409)  # CIFAR-100 stats
