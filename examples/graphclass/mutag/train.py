#!/usr/bin/env python3
"""Train Graph Energy Transformer on MUTAG dataset."""
...
class MUTAGDataModule:
    """Data module for MUTAG dataset."""

    def __init__(self, cfg: DictConfig):
        self.cfg = cfg
        self.num_features = 12  # MUTAG has 7D features + 5D degree features
    ...
    def setup(
        ...
        # MUTAG has 188 samples, we'll use 60/20/20 split
...
def setup_model(cfg: DictConfig) -> GraphEnergyTransformer:
    ...
    config = EnergyTransformerConfig(
        ...
        input_dim=12,  # MUTAG features + degree
...
def setup_training(
    ...
    # Setup data
    data_module = MUTAGDataModule(cfg)
