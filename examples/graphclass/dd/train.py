#!/usr/bin/env python3
"""Train Graph Energy Transformer on DD dataset."""
...
class DDDataModule:
    """Data module for DD dataset."""

    def __init__(self, cfg: DictConfig):
        self.cfg = cfg
        self.num_features = 89  # DD has 89D one-hot node labels
    ...
    def setup(
        ...
        dataset = TUDataset(
            ...
            name="DD",
            use_node_attr=False,  # DD has no node attributes
        )
...
def train_one_epoch(
    ...
    """Train for one epoch."""
    model.train()
    cfg = kwargs["cfg"]  # Use direct access since cfg is required
    kwargs.get("tracker")
...
def save_checkpoint(model: Any, optimizer: Any, scheduler: Any, **kwargs: Any) -> None:
    ...
    cfg = kwargs["cfg"]  # Use direct access
